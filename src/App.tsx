  ...
  return (
    <main className="h-screen bg-blue-main flex place-items-center place-content-center">
      <div className="w-[20rem] bg-blue-card rounded-3xl p-5 space-y-5 text-primary-blue font-thin">
        ...
        <h1 className="text-white text-xl font-bold cursor-pointer hover:text-primary-cyan transition-all duration-300 ease-in-out leading-none">Equilibrium #3429</h1>
        ...
        <div className="flex place-items-center gap-4 text-sm">
          <img className="rounded-full border max-h-8" src={`${process.env.PUBLIC_URL}/images/image-avatar.png`} alt="Avatar" />
          <div>
